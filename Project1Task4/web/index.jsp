<%-- 
    Document   : index
    Created on : Feb 5, 2016, 4:36:27 PM
    Author     : white
--%>
...
<html>
    ...
    <body>
        <h1>Search for Bird Pictures on:</h1>
        <a href= "http://nationalzoo.si.edu/scbi/migratorybirds/featured_photo/">Bird Photo Gallery</a>

        <p> select a bird to display</p>

    <form action="BirdPix" method="GET">
